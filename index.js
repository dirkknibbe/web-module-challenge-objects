...
*/
// function createPet(name, species, behavior) {
//   const newPet = {
//     name,
//     species,
//     behavior
...
function getLastReview(array, rating) {
  /*Your code here*/

  return `${array[7].name} gave the restaurant a ${array[7].rating} star review, and their feedback was: this place is chill with really cool people, great for getting work done on weekdays`
} 
